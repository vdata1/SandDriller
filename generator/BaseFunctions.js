...
module.exports = {
  ...
  //  getReport : getReport,
    ...
    Test262Error : Test262Error,
    asyncGCDeref : asyncGCDeref,
    compareArray : compareArray,
   // $DETACHBUFFER : $DETACHBUFFER,
    start_of_time : start_of_time,
    date_2099_end : date_2099_end,
    date_1969_end : date_1969_end,
    date_1899_end : date_1899_end,
    date_1999_end : date_1999_end,
    checkSequence : checkSequence,
    verifyEqualTo : verifyEqualTo,
    isConstructor : isConstructor,
    arrayContains : arrayContains,
    AsyncFunction : AsyncFunction,
    __globalObject : __globalObject,
    resolveAsyncGC : resolveAsyncGC,
    ...
    allowProxyTraps : allowProxyTraps,
    date_1970_start : date_1970_start,
    date_1900_start : date_1900_start,
    date_2000_start : date_2000_start,
    date_2100_start : date_2100_start,
    taintProperties : taintProperties,
    testNumberFormat : testNumberFormat,
    regExpProperties : regExpProperties,
    verifyEnumerable : verifyEnumerable,
    taintDataProperty : taintDataProperty,
    ...
    testPropertyEscapes : testPropertyEscapes,
    verifyNotEnumerable : verifyNotEnumerable,
    getLocaleSupportInfo : getLocaleSupportInfo,
    checkSettledPromises : checkSettledPromises,
    assertRelativeDateMs : assertRelativeDateMs,
    byteConversionValues : byteConversionValues,
    assertNativeFunction : assertNativeFunction,
    intArrayConstructors : intArrayConstructors,
    getDateTimeComponents : getDateTimeComponents,
    numberingSystemDigits : numberingSystemDigits,
    verifyNotConfigurable : verifyNotConfigurable,
    getInvalidLanguageTags : getInvalidLanguageTags,
    AsyncGeneratorFunction : AsyncGeneratorFunction,
    isValidNumberingSystem : isValidNumberingSystem,
    __consolePrintHandle__ : __consolePrintHandle__,
    floatArrayConstructors : floatArrayConstructors,
    testWithIntlConstructors : testWithIntlConstructors,
    testTypedArrayConversions : testTypedArrayConversions,
    decimalToPercentHexString : decimalToPercentHexString,
    getInvalidLocaleArguments : getInvalidLocaleArguments,
    WellKnownIntrinsicObjects : WellKnownIntrinsicObjects,
    getDateTimeComponentValues : getDateTimeComponentValues,
    testWithAtomicsNonViewValues : testWithAtomicsNonViewValues,
    testForUnwantedRegExpChanges : testForUnwantedRegExpChanges,
    validateNativeFunctionSource : validateNativeFunctionSource,
    regExpPropertiesDefaultValues : regExpPropertiesDefaultValues,
    testWithAtomicsInBoundsIndices : testWithAtomicsInBoundsIndices,
    assertToStringOrNativeFunction : assertToStringOrNativeFunction,
    testWithAtomicsOutOfBoundsIndices : testWithAtomicsOutOfBoundsIndices,
    testWithBigIntTypedArrayConstructors : testWithBigIntTypedArrayConstructors,
    isCanonicalizedStructurallyValidLanguageTag : isCanonicalizedStructurallyValidLanguageTag,
    isCanonicalizedStructurallyValidTimeZoneName : isCanonicalizedStructurallyValidTimeZoneName,
