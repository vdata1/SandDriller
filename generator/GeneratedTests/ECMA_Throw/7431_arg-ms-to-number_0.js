try {
    ...
    assert.sameValue(returnValue, new Date(2016, 6, 1, 0, 0, 0, 2).getTime(), 'application of specified value');
    ...
    assert.sameValue(returnValue, new Date(2016, 6, 1, 0, 0, 0, 1).getTime(), 'true');
    ...
    assert.sameValue(returnValue, new Date(2016, 6, 1, 0, 0, 0, 2).getTime(), 'string');
