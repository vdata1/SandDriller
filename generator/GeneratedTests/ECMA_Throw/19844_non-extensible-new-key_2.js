try {
    testWithTypedArrayConstructors(function (TA) {
        ...
        assert.sameValue(Reflect.defineProperty(sample, 'foo', { value: 42 }), false, 'return false on a non-extensible object - data descriptor');
        ...
        assert.sameValue(Reflect.defineProperty(sample, 'bar', {
            ...
            enumerable: false,
            configurable: true
        }), false, 'return false on a non-extensible object - accessor descriptor');
