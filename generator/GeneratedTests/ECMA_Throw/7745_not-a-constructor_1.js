try {
    assert.sameValue(isConstructor(FinalizationRegistry.prototype.unregister), false, 'isConstructor(FinalizationRegistry.prototype.unregister) must return false');
