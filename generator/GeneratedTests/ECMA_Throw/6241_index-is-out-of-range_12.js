try {
    ...
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(Infinity);
    }, 'DataView access at index Infinity should throw');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(13);
    }, '13 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(12);
    }, '12 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(11);
    }, '11 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(10);
    }, '10 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(9);
    }, '9 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(8);
    }, '8 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(7);
    }, '7 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(6);
    }, '6 + 8 > 12');
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(5);
    }, '5 + 8 > 12');
    sample = new DataView(buffer, 8);
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(1);
    }, '1 + 8 > 4 (offset)');
    sample = new DataView(buffer, 9);
    assert.throws(RangeError, () => {
        let REPLACER = 23;
        return sample.getBigInt64(0);
    }, '0 + 8 > 3 (offset)');
