try {
    ...
    assert.sameValue(typeof test262, 'function', 'generator function value is hoisted');
    assert.sameValue(test262().next().value, 'test262', 'hoisted generator function value is correct');
