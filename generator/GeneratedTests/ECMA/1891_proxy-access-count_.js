try {
    ...
    assert.compareArray(getCalls, [
        ...
        '1',
        '4'
    ], 'getProperty by .flat should occur exactly once per property and once for length and constructor');
    assert.compareArray(hasCalls, [
        ...
        '1',
        '4'
    ], 'hasProperty by .flat should occur exactly once per property');
} catch (e) {
    try {
        e(() => {
