try {
    ...
    assert.sameValue(returnValue, new Date(-1, 42, 7, 11, 36, 23, 2).getTime(), 'application of specified value');
    returnValue = date.setFullYear(null);
    assert.sameValue(returnValue, new Date(-1, 18, 7, 11, 36, 23, 2).getTime(), 'null');
    returnValue = date.setFullYear(true);
    assert.sameValue(returnValue, new Date(-1, 30, 7, 11, 36, 23, 2).getTime(), 'true');
    returnValue = date.setFullYear(false);
    assert.sameValue(returnValue, new Date(-1, 18, 7, 11, 36, 23, 2).getTime(), 'false');
    returnValue = date.setFullYear('   +00200.000E-0002\t');
    assert.sameValue(returnValue, new Date(-1, 42, 7, 11, 36, 23, 2).getTime(), 'string');
