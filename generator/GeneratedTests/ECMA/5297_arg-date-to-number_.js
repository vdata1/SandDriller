try {
    ...
    assert.sameValue(returnValue, new Date(2016, 6, 2, 11, 36, 23, 2).getTime(), 'application of specified value');
    returnValue = date.setMonth(6, null);
    assert.sameValue(returnValue, new Date(2016, 6, 0, 11, 36, 23, 2).getTime(), 'null');
    returnValue = date.setMonth(6, true);
    assert.sameValue(returnValue, new Date(2016, 6, 1, 11, 36, 23, 2).getTime(), 'true');
    returnValue = date.setMonth(6, false);
    assert.sameValue(returnValue, new Date(2016, 6, 0, 11, 36, 23, 2).getTime(), 'false');
    returnValue = date.setMonth(6, '   +00200.000E-0002\t');
    assert.sameValue(returnValue, new Date(2016, 6, 2, 11, 36, 23, 2).getTime(), 'string');
