try {
    ...
    for (const hcValue of hcValues) {
        const resolvedOptions = new Intl.DateTimeFormat(`de-u-hc-${ hcValue }`, { hour: 'numeric' }).resolvedOptions();
    ...
    assert.sameValue(resolvedOptions.hour, undefined, 'Precondition: hour should not be included by default');
