try {
    ...
    if (Number.MIN_VALUE / 2 !== 0) {
        $ERROR('#3: Number.MIN_VALUE / 2.0 === 0. Actual: ' + Number.MIN_VALUE / 2);
    }
    if (Number.MIN_VALUE / -2 !== -0) {
        $ERROR('#4.1: Number.MIN_VALUE / -2.0 === -0. Actual: ' + Number.MIN_VALUE / -2);
    } else {
        if (1 / (Number.MIN_VALUE / -2) !== Number.NEGATIVE_INFINITY) {
