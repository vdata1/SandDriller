try {
    ...
    assert.sameValue(arrayLike.length, 2 ** 53 - 3, 'New length is 2**53 - 3');
    assert.sameValue(arrayLike['9007199254740988'], '9007199254740988', 'arrayLike[\'9007199254740988\'] is unchanged');
