try {
    assert.sameValue(Object.prototype.toString.call(Intl.DateTimeFormat), '[object Function]', 'The [[Class]] internal property of a built-in function must be ' + '"Function".');
