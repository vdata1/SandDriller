try {
    ...
    (0, eval)('if (true) function f() { initialBV = f; f = 123; currentBV = f; return "decl"; } else function _f() {}');
    f();
    ...
    assert.sameValue(f(), 'decl', 'Block-scoped binding is independent of outer var-scoped binding');
} catch (e) {
    try {
        e(() => {
